...
public class PagingDto {
	...
	public PagingDto(int count, int curPage,int page_scale,int block_scale){
		curBlock = 1; // 현재 페이지 블록 번호
		this.curPage = curPage; // 현재 페이지 설정
		this.page_scale=page_scale;
		this.block_scale=block_scale;
		setTotPage(count,page_scale); // 전체 페이지 갯수 계산
		setPageRange(); // 
...
//		pageBegin = (curPage-1)*PAGE_SCALE+1;
		pageBegin = (curPage-1)*page_scale+1;
//		System.out.println("page_scale : "+page_scale  +"begin : "+pageBegin);
