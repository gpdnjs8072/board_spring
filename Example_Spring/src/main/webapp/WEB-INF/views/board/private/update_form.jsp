...
<div class="container">
	<h2>글 수정</h2>
   <form action="update.do" method="post" enctype="multipart/form-data" id="fr">
   	  <input type="hidden" name="searchOption" value="${map.searchOption }" />
   	  <input type="hidden" name="keyword" value="${map.keyword }" />
   	  <input type="hidden" name="curPage" value="${map.curPage }" />
   	  <input type="hidden" name="board_time" value="${map.board_time }" />
     ...
     <div >
         ...
         <input  type="text" id="board_title" name="board_title" value="${dto.board_title }" required="required" v-model="board_title" />
      </div>
      <div >
      ...
      <button type="submit" onclick="submitContents(this);" :disabled="board_title.length<=0">수정확인</button>
